                        ...
                        <div class="box-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <c:forEach items="${orderList}" varStatus="i" var="order">
                                    <tr>
                                        <th><img class="pg" height="140px" width="140px" src="${order.detailGood.img}">
                                        </th>
                                        <th>${order.id}</th>
                                        <th>${order.detailGood.id}</th>
                                        <th>${order.detailGood.name}</th>
                                        <th>${order.num}</th>
                                        <th>${order.detailGood.price * order.num}</th>
                                    </tr>
                                </c:forEach>
...
<script>
    ...
    function beforeFun(num) {
        window.location.href = '/order?page=' + num;
    }
