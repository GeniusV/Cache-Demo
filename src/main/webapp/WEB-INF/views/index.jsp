...
<div id="info" class="callout callout-info" style="
    position: fixed;
    width: 50%;
    z-index: 1000000;
    left: 0;
    right: 0;
    margin: 0 auto;
    background-color: #27d87eb8 !important;
    border-color: #27d87eb8;
    display: none;
">
                    ...
                    <c:forEach items="${goodList}" varStatus="i" var="good">
                        <li class="item">
                            <div class="gl-i-wrap">
                                ...
                                <button type="button" class="buy-btn btn btn-block btn-warning" data-item="${good.id}">
                                    Buy
                                </button>
                            </div>
                        </li>
...
<script>
    ...
    $(".buy-btn").click(function (e) {
        $.get("/buy/" + $(e.target).attr("data-item"),
            function (data) {
                console.log(data);
                if (data.success) {
